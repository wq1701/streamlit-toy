# streamlit run login_simple.py
import streamlit as st
from mods.after_login import after_login
from mods.data_transfer import data_transfer
from mods.data_upload import data_upload

# based on suspicious ChatGPT solution
# I smell sketchy KeyError or AttributeError
...
def main():
    ...
    if st.button("Login"):
        # Check credentials
        if username == "wwq" and password == "123":
            # Store login state
            st.session_state.logged_in = True
            # Redirect to data_transfer page
